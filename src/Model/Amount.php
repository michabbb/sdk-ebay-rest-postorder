...
class Amount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'convertedFromCurrency' => false,
        'convertedFromValue' => false,
        'currency' => false,
        'exchangeRate' => false,
        'value' => false
    ];
    ...
    {
        $this->setIfExists('convertedFromCurrency', $data ?? [], null);
        $this->setIfExists('convertedFromValue', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $convertedFromCurrency convertedFromCurrency
     *
     * @return self
     */
    public function setConvertedFromCurrency($convertedFromCurrency)
    {
        if (is_null($convertedFromCurrency)) {
            throw new \InvalidArgumentException('non-nullable convertedFromCurrency cannot be null');
        }
     ...
     *
     * @param float|null $convertedFromValue convertedFromValue
     *
     * @return self
     */
    public function setConvertedFromValue($convertedFromValue)
    {
        if (is_null($convertedFromValue)) {
            throw new \InvalidArgumentException('non-nullable convertedFromValue cannot be null');
        }
